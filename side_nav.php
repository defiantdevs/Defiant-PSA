...
<aside class="main-sidebar sidebar-dark-<?php echo nullable_htmlentities($config_theme); ?> d-print-none">
    ...
    <img alt="<?=nullable_htmlentities($company_name)?> logo" class="img-fluid" style="max-width: 100%; height: auto;" src="<?php echo !empty($company_logo) ? "./uploads/settings/$company_logo" : "./uploads/settings/wwt-white.png"; ?>">
</div>
    </a>
